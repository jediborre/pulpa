"""Train V5 multi-model predictors for quarter winners (Q3, Q4).

V5 adds strict filtering, exponential momentum slope, genuine points per play,
and trains with advanced non-linear algorithms (XGBoost, HistGradientBoosting, MLP).
"""
...
OUT_DIR = ROOT / "training" / "model_outputs_v5"
TOP_LEAGUES = 20
TOP_TEAMS = 120
...
def main() -> None:
    ...
    print("[train-v5] done")
    print(f"[train-v5] samples_complete={len(samples)}")
    print(f"[train-v5] q3_rows={q3_result['n_rows']}")
    print(f"[train-v5] q4_rows={q4_result['n_rows']}")
    print(f"[train-v5] outputs={OUT_DIR}")
