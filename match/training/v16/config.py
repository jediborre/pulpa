"""
config.py - Fuente unica de verdad para umbrales de V16.
...
# ==============================================================================
# CUTOFFS DE TIEMPO - LIVE MULTI-SNAPSHOT (nuevo en v16)
# ==============================================================================
# En v15 las predicciones solo ocurrian en el pre-cuarto (22 y 31).
# En v16 el engine live predice EN MULTIPLES MINUTOS durante el partido
...
# ==============================================================================
# SELECTOR INTELIGENTE DE LIGAS (nuevo en v16)
# ==============================================================================
# Score minimo (0-100) para que una liga entre al catalogo de training.
# Ver dataset_analyzer.compute_league_score.
USE_LEAGUE_ACTIVATION = True   # usar dataset_analyzer como filtro previo en train
...
# ==============================================================================
# VERSIONADO DE MODELOS (nuevo en v16)
# ==============================================================================
MODEL_VERSIONING_ENABLED = True
WEEKLY_MODELS_DIR = V16_DIR / "model_outputs" / "weekly"
LATEST_LINK_NAME = "latest"  # symlink o carpeta "latest" con la ultima version

# ==============================================================================
# LOGGING ESTRUCTURADO (nuevo en v16)
# ==============================================================================
PREDICTION_LOG_DB = V16_DIR / "logs" / "predictions.db"
PREDICTION_LOG_ENABLED = True

# ==============================================================================
# DRIFT DETECTION (nuevo en v16)
# ==============================================================================
...
# ==============================================================================
# TELEGRAM BOT (nuevo en v16)
# ==============================================================================
TELEGRAM_ENABLED = bool(os.environ.get("V16_TELEGRAM_TOKEN"))
TELEGRAM_TOKEN = os.environ.get("V16_TELEGRAM_TOKEN", "")
TELEGRAM_ALLOWED_CHAT_IDS: tuple[int, ...] = tuple(
    int(x) for x in os.environ.get("V16_TELEGRAM_CHAT_IDS", "").split(",") if x.strip()
)
...
TIMESFM_ENABLED = True                   # True = activar el grupo G8
