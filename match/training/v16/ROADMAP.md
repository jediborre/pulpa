...
reusable `training/v16/ab_compare.py` y reporte
...
- **[NEXT] A/B/C con holdout largo (>= 30 dias).** Las tres corridas del
  ...
  Comando: `./training/v16/.venv311/Scripts/python.exe training/v16/ab_compare.py`.
...
Diagnostico motivador (corrida vigente `training_summary_v16.json`):
...
- Implementado: `training/v16/feature_audit.py`, `config.FEATURE_BLACKLIST`
...
- Reportes: `reports/AB_FEATURE_PRUNING.md`, `reports/FEATURE_AUDIT*.md`,
  `reports/feature_audit.json`, `reports/test_roi_v16_PRUNED.json`.
...
## Criterios para declarar V16 "listo para PROD full"
