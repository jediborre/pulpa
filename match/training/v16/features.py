"""
features.py - Feature engineering de V16.
...
def _get_forecast_extract_fn():
    ...
    if backend == "chronos":
        from training.v16.chronos_features import extract_forecast_features as _fn
        return _fn
    from training.v16.timesfm_features import extract_forecast_features as _fn
    return _fn
...
def build_features_for_sample(
    ...
    # G8 (v16): TimesFM forecast features
    # Si el paquete esta instalado, usa el modelo Google Research.
    # Si no, usa Holt exponential smoothing + bootstrap (contract-compatible).
