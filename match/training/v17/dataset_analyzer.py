"""
dataset_analyzer.py - Analisis inteligente del dataset para v17.
...
def save_report(
    ...
    json_path = out_dir / "league_assessments_v17.json"
    csv_path = out_dir / "league_assessments_v17.csv"
...
def print_report(assessments: list[LeagueAssessment], top: int = 40):
    ...
    print(f"\n{'='*80}")
    print(f"  ANALISIS INTELIGENTE DE LIGAS - V17")
    print(f"{'='*80}")
