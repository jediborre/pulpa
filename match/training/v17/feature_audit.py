"""
feature_audit.py - Auditoria de features de V17.
...
Uso:
    python -m training.v17.feature_audit                 # full audit
    python -m training.v17.feature_audit --quick         # sin permutation
    python -m training.v17.feature_audit --corr 0.92     # umbral personalizado
    python -m training.v17.feature_audit --no-tfm        # ignora tfm_* en drops
    python -m training.v17.feature_audit --sample 15000  # muestrea N filas
    python -m training.v17.feature_audit --trained-only  # solo ligas entrenables
...
from training.v17 import config, dataset as ds, features as feat
...
def _render_markdown(
    ...
    lines: list[str] = []
    lines.append(f"# Feature Audit v17 - target={target}")
    lines.append("")
...
def run_audit(
    ...
    # Combined markdown
    combined_md = "# FEATURE AUDIT v17 (combined)\n\n"
