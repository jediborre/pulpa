"""
cli.py - Entrypoint unificado para V15.

Ejemplos:

  # Entrenar todo:
  python -m training.v15.cli train
  python -m training.v15.cli train --no-cache

  # Backtest sobre holdout con odds 1.40 (default):
  python -m training.v15.cli eval
...
from training.v15 import config, league_overrides


def _cmd_train(args):
    from training.v15 import train
    train.run_training(
...
def _cmd_eval(args):
    from training.v15 import evaluate
...
def _cmd_leagues(args):
    from training.v15.inference import SUMMARY_PATH
...
def _cmd_test_roi(args):
    from training.v15 import test_roi
    test_roi.run(
        odds=args.odds,
        top_n=args.top,
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(prog="v15", description="V15 CLI")
